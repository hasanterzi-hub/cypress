    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    userConfig = _b.sent();
                    return [4 /*yield*/, getResolvedReportJsonPath(merge({}, DEFAULT_CONFIG, userConfig.default, config))];
...
export function getResolvedInputJson(config, mode) {
    if (mode === void 0) { mode = 'served'; }
    return __awaiter(this, void 0, void 0, function () {
        var json, _a;
        var _b;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, getInputJson(config.reportJsonFilePath)];
                case 1:
                    json = _c.sent();
                    _a = [__assign({}, json)];
                    _b = {};
                    return [4 /*yield*/, Promise.all(json.suites.map(function (suite) { return __awaiter(_this, void 0, void 0, function () {
                            var _a;
                            var _b;
                            var _this = this;
                            return __generator(this, function (_c) {
                                        ...
                                        return [4 /*yield*/, Promise.all(suite.tests.map(function (test) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_c) {
                                                    switch (_c.label) {
                                                        case 0:
                                                            _a = [__assign({}, test)];
                                                            _b = { passed: test.status === 'pass' ? 1 : 0, failed: test.status === 'fail' ? 1 : 0, specPath: getNormalisedPath(test.specPath, config, mode) };
                ...
                case 2: return [2 /*return*/, __assign.apply(void 0, _a.concat([(_b.suites = (_c.sent()).map(function (suite) { return (__assign(__assign({}, suite), { id: suite.path, passed: suite.tests.reduce(function (s, i) { return s + i.passed; }, 0), failed: suite.tests.reduce(function (s, i) { return s + i.failed; }, 0), path: getNormalisedPath(suite.path, config, mode) })); }), _b)]))];
            }
        });
    });
}
...
export function getInputJson(filePath) {
    return __awaiter(this, void 0, void 0, function () {
